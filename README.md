...
- **วิเคราะห์แนวโน้ม** — กราฟเปรียบเทียบการใช้งานรายเดือน พร้อมพยากรณ์เดือน
...
├── utils/        ตรรกะล้วน ไม่พึ่ง Firebase/widget (คำนวณรอบบิล, พยากรณ์, วันที่ไทย)
...
- `EnergyForecaster` (ใน `lib/utils/forecaster.dart`) รวมตรรกะเรื่องขอบเขตรอบบิล
  และการพยากรณ์ไว้เป็นแหล่งความจริงเดียว ไม่ให้แต่ละหน้าจอคำนวณเองแยกกัน
