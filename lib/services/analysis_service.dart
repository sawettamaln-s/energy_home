...
class AnalysisService {
  ...
  ///
  /// หมายเหตุ: ไม่กรองด้วย appliance.isActive แล้ว เพราะหน้าอุปกรณ์ไม่มี UI
  /// ให้ผู้ใช้ปิด/เปิดอุปกรณ์อีกต่อไป (ไม่ได้เก็บข้อมูลส่วนนี้จริง ค่า
  /// isActive จะเป็น true เสมอ) — กรองด้วยการมีตารางการใช้งานพออย่างเดียว
