...
/// ===========================================================
/// ชุดฟิลด์ "เลขมิเตอร์สะสมต้นรอบ + ค่าใช้จ่ายบิลล่าสุด" — เดิมใช้ร่วมกัน
/// ทั้งหน้าตั้งค่า > บันทึกมิเตอร์ต้นรอบ (settings_start_meter.dart) และขั้นตอน
/// ตั้งค่าเริ่มต้นตอนสมัคร (setup_screen.dart) แต่ตอนนี้ขั้นตอนนั้นถูกตัด
/// ออกจากเซตอัพแล้ว จึงเหลือผู้เรียกใช้จริงแค่จุดเดียวคือ
/// settings_start_meter.dart — ยังคงแยกไฟล์ไว้ต่างหากเพราะตัว widget +
/// validation logic มีขนาดใหญ่พอสมควร ไม่ใช่เพราะใช้ร่วมกันหลายจุดแล้ว
///
