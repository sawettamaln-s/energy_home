...
/// หน้าสรุปหลังทำ setup wizard เสร็จ — เช็คลิสต์เตือนว่ายังมี "วันตัดรอบบิล"
/// และ "ค่ามิเตอร์ตั้งต้น" ค้างให้ไปกรอกต่อก่อนใช้งานจริง โชว์ให้ทุกบัญชีใหม่
/// เห็นเสมอ (สองค่านี้เป็น false เสมอตอนสร้างบัญชี) แต่ละรายการแตะไปหน้า
/// ตั้งค่าเรื่องนั้นๆ ผ่าน SettingsQuickAction แล้วรีเฟรชสถานะให้อัตโนมัติ
