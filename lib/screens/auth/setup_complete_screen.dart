...
/// หน้าสรุปหลังทำ setup wizard เสร็จ — เป็นเช็คลิสต์เตือนว่ายังมี "วันตัดรอบบิล"
/// และ "ค่ามิเตอร์ตั้งต้น" ค้างให้ไปกรอกต่อที่หน้าตั้งค่าก่อนเข้าใช้งานจริง
///
/// ปัจจุบัน setup_screen.dart ตัดสองขั้นตอนนี้ออกจาก wizard ไปแล้ว (ย้ายไป
/// กรอกที่หน้าตั้งค่าแทนทั้งหมด) ทุกบัญชีใหม่จึงจบ wizard แบบ "ยังไม่ตั้ง"
/// เสมอ (billingDayConfigured/startMeterConfigured = false เสมอตอนสร้าง
/// บัญชี) แปลว่าหน้านี้จะโชว์ให้ทุกบัญชีใหม่เห็นเสมอ 100% ไม่มีเงื่อนไข
/// ให้ setup_screen.dart ข้ามหน้านี้ไปอีกต่อไป (ต่างจากดีไซน์เดิมตอนที่
/// wizard ยังมีสองขั้นตอนนี้ให้กรอก ซึ่งตอนนั้นจะข้ามหน้านี้ได้ถ้ากรอกครบ)
///
