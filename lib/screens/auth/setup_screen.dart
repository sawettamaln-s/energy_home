  ...
  Widget _buildAreaAndRateExplanationStep() {
    ...
    final electricityLine = isBangkok
        ? '• ค่าไฟ (MEA): คิดขั้นบันไดตามหน่วยที่ใช้ บวกค่า Ft และค่าบริการ'
            'รายเดือน (อัตรา 1.2 ใช้เกิน 150 หน่วยต่อเดือน)'
        : '• ค่าไฟ (PEA): คิดขั้นบันไดตามหน่วยที่ใช้ บวกค่า Ft และค่าบริการ'
            'รายเดือน (ใช้อัตราประเภท 1.1.2 ใช้เกิน 150 หน่วยต่อเดือน)';
