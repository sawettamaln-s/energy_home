...
class DashboardStyles {
  ...
  // เดิมเป็น 0xFF2F9E8F (เขียวอมฟ้า) ทำให้บางจุดที่ใช้สีนี้ (กรอบการ์ดน้ำ,
  // ไอคอนในฟอร์มตั้งค่ามิเตอร์ต้นรอบ, เส้นกราฟหน้าวิเคราะห์) ดูออกโทนเขียว
  // ไม่ตรงกับโทนฟ้าที่ชอบ (ตามภาพที่แนบ) เปลี่ยนเป็นฟ้าล้วนแทน ไม่ปนเขียว
