...
// จาก isTou ตามที่คอมเมนต์ในไฟล์เดิมอธิบายไว้
//
// ครอบว่าแต่ละ combination ของ (isElectricity, area, isTou) เลือกผู้
// ให้บริการ/โครงสร้างตารางถูกต้อง — เป็นจุดที่เคยมีบั๊กจริงมาก่อน (ดู
// ประวัติงานก่อนหน้า: บั๊กสีของ estimated-cost banner ที่ผสมกันระหว่าง
// ไฟฟ้า/น้ำ) จึงคุ้มค่าที่จะมีเทส regression กันไว้
//
